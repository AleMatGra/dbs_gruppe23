...
\author{Boiko Bohdana, Alexander Grath}
\date{} % empty date
%----------------------------------------------------------------------------
...
% #############################################
%
\section{Definition des Realitätsausschnittes}
%
...
\begin{itemize}
	...
	\item \textbf{Straßenbahnen}: haben eine \textbf{Spurweite} (in Wien Normalspur) und \textbf{Stromsystem} (in Wien Gleichstrom mit Oberleitungs-Stromabnehmer)
\end{itemize}
...
\end{itemize}
Für Ausbildungszwecke und auch für den normalen Betrieb (Schichtwechsel) kann es vorkommen das ein Fahrer:in mehrere andere Fahrer:innen transportiert bzw. \textit{betreut}.
...
\begin{itemize}
	...
	\item \textbf{Haltestellen}: mit einer \underline{\textit{Identifikation}}, einem \textit{Namen} und \textit{Barrierefreiheit}.
\end{itemize}
